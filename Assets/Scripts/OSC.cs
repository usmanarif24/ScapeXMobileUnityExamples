...
//{
  ...
  public class OSC : MonoBehaviour
  {
    ...
    void Configuration()
    {
        ...
        ini.Open(Path.Combine(Application.streamingAssetsPath, "settings.ini"));
        outIP = ini.ReadValue("osc", "ip", "10.255.254.255");
        outPort = int.Parse(ini.ReadValue("osc", "out", "12000"));
        inPort = int.Parse(ini.ReadValue("osc", "in", "4000"));
        ini.Close();
    }
